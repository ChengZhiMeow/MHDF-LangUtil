...
import cn.chengzhiya.langutil.manager.biome.BiomeManager;
import cn.chengzhiya.langutil.manager.biome.BukkitBiomeManagerImpl;
import cn.chengzhiya.langutil.manager.biome.BukkitOldBiomeManagerImpl;
...
public final class LangAPI {
    ...
    public LangAPI(JavaPlugin plugin, File langFileFolder) {
        ...
        try {
            Biome.class.getDeclaredMethod("getKey");
            this.biomeManager = new BukkitBiomeManagerImpl();
        } catch (NoSuchMethodException e) {
            this.biomeManager = new BukkitOldBiomeManagerImpl();
        }
